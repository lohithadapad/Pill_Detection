...
for p in ports:
    if 'COM4' in p.device:  # Replace 'COM3' with the name of your serial port
        port = p.device
        break
...
alarm_sound = pygame.mixer.Sound('c:/Users/Lohit/Desktop/finale/alarm_sound.mp3')
